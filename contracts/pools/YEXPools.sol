...
contract YEXPools is OwnableUpgradeable, IActionTrigger, IClaimFromBank {
    ...
    // The YEX TOKEN!
    YEXToken public rewardToken;
    // YEX tokens created per block.
    ...
    function initialize(
        ...
        bank = _bank;
        rewardToken = YEXToken(_rewardToken);
