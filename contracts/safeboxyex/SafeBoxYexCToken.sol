...
import "./SafeBoxYexCTokenImpl.sol";

contract SafeBoxYexCToken is SafeBoxYexCTokenImpl, ReentrancyGuardUpgradeable, OwnableUpgradeable, ICompActionTrigger, ISafeBox {
    ...
    function __SafeBoxYexCToken_init(address _bank, address _cToken, address _devAddr) public initializer {
        __Ownable_init();
        __ReentrancyGuard_init();

        __SafeBoxYexCTokenImpl__init(_cToken);
